...
//	mvGyroToEncoder(50,-90)
		turn(-315, 100);					  /*(int new_kurs, int v_max)*/				 playTone(600,10);
//	mvGyroToEncoder(50,-135)
...
//	mvGyroToEncoder(50,-90)
		turn(-495, 100);					  /*(int new_kurs, int v_max)*/				 playTone(600,10);
//	mvGyroToEncoder(50,-135)
		turn(-535, 100);					  /*(int new_kurs, int v_max)*/				 playTone(600,10);
