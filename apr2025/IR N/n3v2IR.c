...
task main()
{
	...
	mvGyroToEncoder(360, -90);	/*(int EnkoderTarget, int gyroTaget)*/	playTone(600,10);
	...
	mvGyroToEncoder(320, -270);	/*(int EnkoderTarget, int gyroTaget)*/	playTone(600,10);
	turn(-340, 100);					  /*(int new_kurs, int v_max)*/				 playTone(600,10);
