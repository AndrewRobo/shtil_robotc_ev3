...
mvGyroRightToEncoder(2000, 0);	  /*(int EnkoderTarget, int giroTagetXZ)*/playTone(600,10);
mvGyroRightToLeftBui(0, 40); 	/*(int giroTagetXZ, int LeftBui)*/playTone(600,10);
...
TurnAnRadius(-70, 100, -220);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);
mvGyroToEncoder(800, -220);	/*(int EnkoderTarget, int gyroTaget)*/playTone(600,10);
TurnAnRadius(100, -70, -190);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);

// vtoroi bui   ( blignij k startu )
mvGyroLeftToRightBui(-180, 40); 	/*(int giroTagetXZ, int LeftBui)*/playTone(600,10);
TurnAnRadius(100, -70, -20);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);

// obratnaya diagonal
mvGyroLeftToEncoder(1000, 0);	/*(int EnkoderTarget, int giroTagetXZ)*/playTone(600,10);
TurnAnRadius(100, -70, 45);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);
mvGyroToEncoder(800, 45);	/*(int EnkoderTarget, int gyroTaget)*/playTone(600,10);
TurnAnRadius(-70, 100, 15);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);

// vtoroi raz vokrug pervogo buya
mvGyroRightToLeftBui(0, 40); 	/*(int giroTagetXZ, int LeftBui)*/playTone(600,10);
TurnAnRadius(-70, 100, -160);	/*(int v_left, int v_right, int giroTagetXZ)*/playTone(600,10);
