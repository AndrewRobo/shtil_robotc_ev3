...
int distants_k_gyro_rotate = 5;
int speed_koef_gyro_rotate = 2;
...
void rotate_boat(int kuyrs/*-210*/, int v_max)
{
			...
			while (1) {
				...
				dynamic_speed -= speed_koef_gyro_rotate*(abs(distants_error));
				if (dynamic_speed>100)
					dynamic_speed=v_max;
				else if (dynamic_speed<-v_max)
					dynamic_speed=-v_max;
				...
				kurs_war = distants_k_gyro_rotate * distants_error;
...
kyrs(90,1);
 ...
 dvig_po_byu3(80,0,50,-180, 3);
	kyrs_rul_gir_bye(0, 80, 100);
	rotate_boat(-90, 80);
	kyrs_rul_gir_bye(-90, 80, 100);
	rotate_boat(-180, 80);
	kyrs_rul_gir_bye(-180, 80, 100);
	rotate_boat(-270, 80);
	kyrs_rul_gir_bye(-270, 80, 1);
