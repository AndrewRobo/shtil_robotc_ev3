...
task main()
{
	...
	int speed_main = 70;
	kyrs_rul_gir_bye(0, speed_main, 50);
	rotate_boat(-90, speed_main);

	kyrs_rul_gir_bye(-90, speed_main, 50);
	rotate_boat(-175, speed_main);

	kyrs_rul_gir_bye(-175, speed_main, 50);
	rotate_boat(-265, speed_main);

	kyrs_rul_gir_bye(-265, speed_main, 50);
	rotate_boat(-355, speed_main);

	kyrs_rul_gir_bye(-355, speed_main, 50);
	rotate_boat(-445, speed_main);

	kyrs_rul_gir_bye(-445, speed_main, 50);
	rotate_boat(-535, speed_main);

	kyrs_rul_gir_bye(-535, speed_main, 50);
	rotate_boat(-625, speed_main);

	kyrs_rul_gir_bye(-625, speed_main, 15);
