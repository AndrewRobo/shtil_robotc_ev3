...
task main()
{
	...
	int speed_main = 100;
	kyrs_rul_gir(0, speed_main,75);
	rotate_boat(-90, speed_main);
	kyrs_rul_gir(-90, speed_main, 75);
	rotate_boat(-180, speed_main);
	kyrs_rul_gir(-180, speed_main, 75);
	rotate_boat(-270, speed_main);
	kyrs_rul_gir(-270, speed_main, 75);
	rotate_boat(-350, speed_main);
	kyrs_rul_gir(-350, speed_main, 75);
	rotate_boat(-440, speed_main);
	kyrs_rul_gir(-440, speed_main, 75);
	rotate_boat(-525, speed_main);
	kyrs_rul_gir(-525, speed_main, 25);
